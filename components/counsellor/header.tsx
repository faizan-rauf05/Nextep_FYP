...
export function CounsellorHeader() {
  const [notifications] = useState([
    ...
    { id: 2, message: "Session completed with feedback pending", time: "1h ago" },
    { id: 3, message: "Earnings update: Rs. 4,500 added this week", time: "2h ago" },
  ])
          ...
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" className="gap-2 pl-2 pr-3">
              <Avatar className="h-8 w-8">
                <AvatarFallback className="bg-foreground text-background text-xs">DC</AvatarFallback>
              </Avatar>
              <span className="hidden sm:inline text-sm font-medium">Counsellor</span>
            </Button>
          </DropdownMenuTrigger>
