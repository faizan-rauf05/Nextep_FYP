...
export function StudentHeader() {
  const [notifications] = useState([
    { id: 1, message: "Your session with Dr. Amanda is in 2 hours", time: "10m ago" },
    { id: 2, message: "New career recommendations available", time: "1h ago" },
    { id: 3, message: "Session feedback received", time: "3h ago" },
  ])
          ...
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" className="gap-2 pl-2 pr-3">
              <Avatar className="h-8 w-8">
                <AvatarFallback className="bg-foreground text-background text-xs">SJ</AvatarFallback>
              </Avatar>
